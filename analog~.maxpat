...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.686646, 116.0, 295.0, 33.0 ],
					"text" : "based on Tom Szilagyi plugin:\nhttp://tap-plugins.sourceforge.net/ladspa/sigmoid.html"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.686646, 9.0, 115.0, 20.0 ],
					"text" : "some preset values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 129.0, 60.0, 20.0 ],
					"text" : "audio out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 9.0, 53.0, 20.0 ],
					"text" : "audio in"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 105.0, 44.0, 20.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 29.0, 35.0, 37.0, 20.0 ],
					"text" : "in~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 199.529999, 35.0, 53.0, 20.0 ],
					"text" : "sig~ 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 142.686646, 35.0, 47.0, 20.0 ],
					"text" : "sig~ -3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.843323, 35.0, 43.0, 20.0 ],
					"text" : "sig~ 3"
				}
...
,
					"patching_rect" : [ 29.0, 70.5, 189.529999, 20.0 ],
					"text" : "gen~"
				}
