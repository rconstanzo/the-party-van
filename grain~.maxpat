...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 634.0, 265.0, 47.0 ],
					"text" : "based on SugarSynth by\nNobuyasu Sakonda\nhttp://cycling74.com/forums/topic.php?id=33156"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 401.0, 121.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 224.0, 93.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 106.0, 112.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 393.0, 133.0, 85.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 280.0, 85.0, 47.0 ],
					"text" : "synvhronized\ncos envelope\nfor windowing"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 340.0, 57.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 509.0, 48.0, 33.0 ],
					"text" : "stereo spread"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 23.0, 24.0, 79.0, 20.0 ],
									"text" : "signal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 114.0, 8.0, 64.0, 33.0 ],
									"text" : "pan\n(0.0〜1.0)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 38.0, 219.0, 69.0, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 128.0, 219.0, 69.0, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 178.0, 174.0, 45.0, 20.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 88.0, 174.0, 45.0, 20.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 204.0, 143.0, 51.0, 20.0 ],
									"text" : "+~ 0.75"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 114.0, 98.0, 49.0, 20.0 ],
									"text" : "*~ 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 114.0, 53.0, 25.0, 25.0 ]
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 123.5, 131.0, 213.5, 131.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 200.0, 430.0, 56.0, 20.0 ],
					"text" : "play~ #1"
				}
