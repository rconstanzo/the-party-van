...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 181.5, 70.089844, 540.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 197.0, 58.5, 64.0, 22.0 ],
									"style" : "",
									"text" : "repeats 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 92.0, 58.5, 89.0, 22.0 ],
									"style" : "",
									"text" : "pitchedmode 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 18.0, 58.5, 61.0, 22.0 ],
									"style" : "",
									"text" : "capture 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 18.0, 15.0, 60.0, 22.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
,
					"patching_rect" : [ 94.5, 105.5, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.833313, 105.5, 79.0, 22.0 ],
					"style" : "",
					"text" : "playmode $1"
				}
...
,
					"patching_rect" : [ 77.0, 157.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "gen~"
				}
...
,
					"patching_rect" : [ 442.0, 105.5, 43.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 355.166656, 105.5, 40.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 268.333344, 105.5, 49.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 181.5, 105.5, 41.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 341.0, 60.0, 20.0 ],
					"style" : "",
					"text" : "audio out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 13.0, 53.0, 20.0 ],
					"style" : "",
					"text" : "audio in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.5, 36.0, 30.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 77.0, 36.0, 37.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 319.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 42.0, 251.5, 35.0, 22.0 ],
					"style" : "",
					"text" : "!-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.0, 195.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 28.5, 278.5, 32.5, 22.0 ],
					"style" : "",
					"text" : "*~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 90.5, 219.5, 46.0, 22.0 ],
					"style" : "",
					"text" : "line~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 77.0, 278.5, 32.5, 22.0 ],
					"style" : "",
					"text" : "*~ 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 538.333313, 146.75, 86.5, 146.75 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 191.0, 146.25, 86.5, 146.25 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 104.0, 135.75, 86.5, 135.75 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 625.166687, 187.044922, 100.5, 187.044922 ],
					"source" : [ "obj-2065", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 86.5, 121.25, 38.0, 121.25 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 277.833344, 146.25, 86.5, 146.25 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 364.666656, 146.25, 86.5, 146.25 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 451.5, 146.25, 86.5, 146.25 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 100.0, 245.0, 51.5, 245.0 ],
					"source" : [ "obj-48", 0 ]
				}
